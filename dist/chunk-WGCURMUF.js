...
var defaultOptions = {
  ...
  navLinks: [
    ...
    { text: "Blog", href: "/blogs", icon: "blog" },
    // Fixed: matches your actual /blogs folder
    { text: "Categories", href: "/tags", icon: "categories" },
    // Fixed: Quartz uses /tags for categories
