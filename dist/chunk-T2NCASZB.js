...
// src/author-line.tsx
var AuthorLine = (userOpts) => {
  const opts = { ...userOpts };
  const Component = ({ fileData, cfg }) => {
    if (!fileData || fileData.slug === "index") return /* @__PURE__ */ u2(S, {});
    const dateRaw = fileData.dates?.modified ?? fileData.dates?.created;
    if (!dateRaw) return /* @__PURE__ */ u2(S, {});
    const author = fileData.frontmatter?.author ?? opts.defaultAuthor;
    const locale = cfg?.locale ?? "en-US";
    ...
    return /* @__PURE__ */ u2("p", { class: "author-line", children: [
      author && /* @__PURE__ */ u2("span", { class: "author-name", children: author }),
      author && /* @__PURE__ */ u2("span", { class: "author-sep", children: "\xA0\u2022\xA0" }),
      /* @__PURE__ */ u2("span", { class: "author-date", children: date })
    ] });
  };
  Component.css = styles_default;
  return Component;
